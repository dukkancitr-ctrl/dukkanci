...
function buildSystemPrompt(catalog, questionsAsked, forceFinal) {
  ...
  return [
    ...
    "الحالة (كـ\"دجاج\"/\"لحم\"، أو \"مكسرات\"/\"تسالي\") دون وضوح إن كان المقصود طبقاً جاهزاً أو",
    "تسالي جاهزة للأكل مباشرة، أم مكوّناً نيئاً (لحماً نيئاً للطبخ، أو مكسرات نيئة تحتاج تحميصاً)",
    "يحتاج تحضيراً في البيت — هذا الغموض بالذات كان سبب اقتراحات خاطئة فعلياً (مكسرات نيئة",
    "للطبخ ظهرت كأنها تسالي جاهزة)، فلا تتجاهله أبداً عند طلب مكسرات/تسالي. سؤال واحد",
    ...
    "  المقصود طبقاً جاهزاً من مطعم أو لحماً نيئاً للطبخ في البيت، وبنفس القدر عند طلب",
    "  \"مكسرات\"/\"تسالي\" دون وضوح إن كان المقصود تسالي محمّصة جاهزة للتقديم مباشرة أم مكسرات",
    "  نيئة (خام) يشتريها العميل ليحمّصها أو يخبز بها بنفسه.",
